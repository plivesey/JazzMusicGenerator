...
public class SongComposer {
  ...
  public class func generateMelodyForChordMeasures(chordMeasures: [ChordMeasure], startNote: Int, endNote: Int) -> [ChordNoteMeasure] {
  ...
  public class func generateSoloSection(chordMeasures: [ChordMeasure], startNote: Int, endNote: Int) -> [ChordNoteMeasure] {
