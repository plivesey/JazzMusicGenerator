...
public class JazzChordGenerator {
  
  public class func generateRandomChords(#numMeasures: Int, key: Int) -> [ChordMeasure] {
    assert(key >= 0 && key < 12)
  ...
  public class func generateRandomChords(#numMeasures: Int) -> [ChordMeasure] {
  ...
  public class func generateEndingChordsStarting(startingChord: ChordData, numberOfMeasures: Int) -> [ChordMeasure] {
